...
### Changed
- [Url] Default ports are now skipped during url building

### Fixed
- [Router] URL generation will not render default ports on http and https protocols


## [0.9.1] - 2025-11-02

### Fixed
- [Router] passing a port in `BASE_URL` is now optional

## [0.9.0] - 2025-09-22

### Added
- [Router] Wildcard routes
- [Router] Custom regexp can be now used for path parameter validation

### Changed
- Router was refactored to allow more use cases.

## [0.5.0] - 2025-03-21

### Changed
- Bumped `dynamite/dynamite`
- Bumped `doctrine/orm` and `doctrine/dbal`
